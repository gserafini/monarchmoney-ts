...
export type GraphQLOperation = 'GetAccounts' | 'GetTransactions' | 'GetBudgets' | 'GetHoldings' | 'CreateTransaction' | 'UpdateTransaction' | 'DeleteTransaction' | 'Login' | 'MultiFactorAuth';
