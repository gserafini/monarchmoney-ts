...
exports.TransactionsAPIImpl = void 0;
...
class TransactionsAPIImpl {
    ...
    async getTransactions(options = {}) {
        ...
        utils_1.logger.debug('Getting transactions with options:', variables);
    ...
    `;
        ...
        utils_1.logger.debug(`Retrieved ${data.allTransactions.results.length} transactions using web app schema`);
        return {
    ...
    async getTransactionDetails(transactionId) {
        (0, utils_1.validateTransactionId)(transactionId);
        const query = `
    ...
    `;
        ...
        utils_1.logger.info('Transaction created successfully:', result.createTransaction.transaction.id);
    ...
    `;
        ...
        utils_1.logger.info('Transaction updated successfully:', transactionId);
    ...
    `;
        ...
        utils_1.logger.info('Transaction deleted successfully:', transactionId);
    ...
    `;
        ...
        utils_1.logger.info('Transaction rule created successfully');
    ...
    `;
        ...
        utils_1.logger.info('Transaction rule updated successfully:', ruleId);
    ...
    `;
        ...
        utils_1.logger.info('Transaction rule deleted successfully:', ruleId);
    ...
    `;
        ...
        utils_1.logger.info('All transaction rules deleted successfully:', result.deleteAllTransactionRules.deletedCount);
    ...
    `;
        ...
        utils_1.logger.info('Category created successfully:', result.createCategory.category.id);
    ...
    `;
        ...
        utils_1.logger.info('Category updated successfully:', categoryId);
    ...
    `;
        ...
        utils_1.logger.info('Category deleted successfully:', categoryId);
    ...
    `;
        ...
        utils_1.logger.info('Transaction tag created successfully:', result.createTransactionTag.tag.id);
    ...
    `;
        ...
        utils_1.logger.info('Transaction tags updated successfully:', transactionId);
    ...
    `;
        ...
        utils_1.logger.info('Recurring stream reviewed successfully:', streamId);
    ...
    `;
        ...
        utils_1.logger.info('Stream marked as not recurring successfully:', streamId);
    ...
    `;
        ...
        utils_1.logger.info('Bulk transaction update completed:', result.bulkUpdateTransactions.affectedCount);
...
exports.TransactionsAPIImpl = TransactionsAPIImpl;
