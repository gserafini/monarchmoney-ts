 ...
 */
export function getQueryForVerbosity(queryType, verbosity) {
    switch (queryType) {
        case 'accounts':
            if (verbosity === 'ultra-light')
                return GET_ACCOUNTS_ULTRA_LIGHT;
            if (verbosity === 'light')
                return GET_ACCOUNTS_LIGHT;
            return GET_ACCOUNTS;
        case 'transactions':
            if (verbosity === 'ultra-light')
                return GET_TRANSACTIONS_ULTRA_LIGHT;
            if (verbosity === 'light')
                return GET_TRANSACTIONS_LIGHT;
            return GET_TRANSACTIONS;
        case 'categories':
            if (verbosity === 'ultra-light' || verbosity === 'light')
                return GET_CATEGORIES_LIGHT;
            return GET_TRANSACTION_CATEGORIES;
        case 'budgets':
            if (verbosity === 'ultra-light' || verbosity === 'light')
                return GET_BUDGETS_LIGHT;
            return GET_BUDGETS;
        default:
