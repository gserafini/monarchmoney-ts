...
export class ResponseFormatter {
     ...
     */
    static formatAccounts(accounts, verbosity) {
        switch (verbosity) {
            case 'ultra-light': {
     ...
     */
    static formatTransactions(transactions, verbosity, originalQuery) {
     ...
     */
    static formatQuickStats(accounts, recentTransactions) {
     ...
     */
    static formatSpendingSummary(transactions, topN = 5) {
