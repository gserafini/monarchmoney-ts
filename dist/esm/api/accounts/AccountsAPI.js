import { GET_ACCOUNT_DETAILS, GET_ACCOUNT_TYPE_OPTIONS, GET_NET_WORTH_HISTORY } from '../../client/graphql/operations';
import { getQueryForVerbosity } from '../../client/graphql/operations';
import { validateAccountId, 
// validateDate,
validateDateRange, logger } from '../../utils';
export class AccountsAPIImpl {
    constructor(graphql) {
    ...
    async getById(id) {
        ...
        try {
            const response = await this.graphql.query(GET_ACCOUNT_DETAILS, { id }, { cache: true, cacheTTL: 300000 });
    ...
    async getTypeOptions() {
        ...
        try {
            const response = await this.graphql.query(GET_ACCOUNT_TYPE_OPTIONS, {}, { cache: true, cacheTTL: 1800000 }); // 30 minutes
    ...
    async getNetWorthHistory(startDate, endDate) {
        ...
        try {
            ...
            const response = await this.graphql.query(GET_NET_WORTH_HISTORY, { filters }, { cache: true, cacheTTL: 600000 }); // 10 minutes
