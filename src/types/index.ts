...
// Matches Monarch's actual TransactionRuleV2 shape captured from web app (2026-02-03)
export interface TransactionRule {
  id: string
  order?: number
  merchantCriteriaUseOriginalStatement?: boolean
  merchantCriteria?: Array<{ operator: string; value: string }> | null
  originalStatementCriteria?: Array<{ operator: string; value: string }> | null
  ...
  accounts?: Array<{ id: string; displayName: string; icon?: string; logoUrl?: string }> | null
  setMerchantAction?: { id: string; name: string } | null
  setCategoryAction?: { id: string; name: string; icon?: string } | null
  addTagsAction?: Array<{ id: string; name: string; color?: string }> | null
  reviewStatusAction?: string | null
  splitTransactionsAction?: {
    amountType: string
    splitsInfo: Array<{ categoryId?: string; merchantName?: string; amount?: number }>
  } | null
